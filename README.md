# The Challenge reisorganisatiesystem
 ...
 * Ons team heeft rekening gehouden met alle aspecten van UI / UX-ontwerp. Het team selecteren een eenvoudige oplossing:
   ...
   + eenvoudige CSS-snytax.
   + schaalbaarheid: eenvoudig om alle pagina's te bouwen op basis van sjabloonpagina's. Sjabloonpagina's zijn: 'from page', 'list page' en 'details page'.
